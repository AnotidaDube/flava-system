"""
Django settings for flava_backend project.
...
SECRET_KEY = 'django-insecure-et9j+mcvf@0_ufm55^*vsxa#92)ro7!^_h1iowxrvkpx=zd_m3'
...
ROOT_URLCONF = 'flava_backend.urls'
...
WSGI_APPLICATION = 'flava_backend.wsgi.application'
